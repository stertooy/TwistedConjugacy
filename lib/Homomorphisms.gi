...
##
##  REMARKS:
##                  This is essentially the code of AllHomomorphismClasses, but
##                  with some minor changes to remove redundant code. It
##                  assumes H is generated by exactly 2 elements.
##
